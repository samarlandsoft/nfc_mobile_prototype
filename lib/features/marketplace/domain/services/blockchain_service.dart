...
class BlockchainService {
  ...
  Future<List<BlockchainOwnerships>> getHistory(
      CryptoCurrency currency) async {
    logDebug('BlockchainService -> getHistory($currency)');
    ...
    final List<BlockchainOwnerships> histories = [];
    ...
    for (var event in transferEventLogs) {
      ...
      final history = BlockchainOwnerships(
